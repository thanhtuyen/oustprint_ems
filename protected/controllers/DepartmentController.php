...
class DepartmentController extends Controller
{
  ...
  public function accessRules()
  {
    if( Yii::app()->user->getState('roles') =="admin") {
      ...
      $arr =array('admin');   /* give all access to manager*/
    } elseif( Yii::app()->user->getState('roles') =="leader") {

      $arr =array( 'admin');   /* give all access to leader*/
    } else {

      $arr = array('admin');    /*  no access to other user */
    }
...
//    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/jquery.roundabout2js.js');
//    Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl.'/js/min.js');
