...
class ActivityType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('activity_description', 'required'),
			array('activity_description', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, activity_description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'activityLogs' => array(self::HAS_MANY, 'ActivityLog', 'activity_type'),
		);
	}
